...
module.exports = function (args, done) {
  ...
  function updateDojo (cb) {
    ...
    function saveDojo (sCb) {
      ...
      dojoApplication.frequency = dojoApplication.frequency;
      dojoApplication.day = dojoApplication.day;
      dojoApplication.startTime = dojoApplication.startTime;
      dojoApplication.endTime = dojoApplication.endTime;
