...
module.exports = function (args, done) {
  ...
  function securityChecks (cb) {
    if (originalLead) {
      ...
      if (lead.dojo && originalLead.dojo &&
         lead.dojo.id !== originalLead.dojo.id) {
        return done('You cannot change the lead dojo of an application');
      }
    }
    cb();
  }
  ...
  function updateDojo (cb) {
    ...
    // The minimal dojo payload should have a name
